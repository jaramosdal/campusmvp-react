...
import FormularioRegistro, { action as registroAction } from './features/sesion/Registro'
...
import { PaginaProtegida, loader as sesionLoader } from './features/sesion/PaginaProtegida'
import { loader as logoutLoader } from './features/sesion/logout'
import FormularioLogin, { action as loginAction } from './features/sesion/Login'
...
const router = createBrowserRouter(createRoutesFromElements(
  <Route path='/' element={<App />} >
    ...
    <Route path='cuenta' element={<PantallaAcceso />}>
      ...
      <Route path='acceder' element={<FormularioLogin />}  action={loginAction} />
      <Route path='crear' element={<FormularioRegistro />} action={registroAction} />
